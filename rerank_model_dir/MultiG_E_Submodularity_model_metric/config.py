...
TRAIN_MODE = 3
MODEL_NAME = "MultiGE_submodularity_metric_checkpoint"
...
if DATA_MODE == 1:
    ...
    TRAIN_FILE = ["/home/liushuchang/.jupyter/hailan_workspace/avito_v3_new/train_data/part-r-00000"]
    VALID_FILE = ["/home/liushuchang/.jupyter/hailan_workspace/avito_v3_new/test_data/part-r-000*"]
    TEST_FILE= ["/home/liushuchang/.jupyter/hailan_workspace/avito_v3_new/test_data/part-r-000*"]
elif DATA_MODE == 4:

...
class DNN:
    ...
    def _create_loss(self, labels):
        with tf.name_scope('loss'):
            ...
            # ctr_loss
            self.loss = tf.reduce_mean(tf.losses.sigmoid_cross_entropy(self.label, self.first_value_of_beamK_output, weights=self.mask))
	...
	self.first_value_of_beamK_output = self.beamK_output[:, 0, :]
        # 输出avg-ctr最高的序列
